...
public class PotionNBTList implements IExtendedEntityProperties
{
	...
	public static final String NBTNAME = "lilithPotionEffects";
	private NBTTagList potionsList = new NBTTagList();

	 public static PotionNBTList get(EntityLivingBase entity){
	...
	{
		this.potionsList = compound.getTagList(NBTNAME, Constants.NBT.TAG_COMPOUND);
	}
