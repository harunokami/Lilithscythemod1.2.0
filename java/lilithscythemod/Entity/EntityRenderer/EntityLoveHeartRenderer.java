...
public class EntityLoveHeartRenderer extends Render{
	//弾のテクスチャ登録
    ...
    public EntityLoveHeartRenderer(ModelBase par1ModelBase)
    {
		super();
		this.modelBullet = par1ModelBase;
		this.shadowSize = 0.0F;
	}
	public void renderArrow(EntityLoveHeart par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
	...
	{
		this.renderArrow((lilithscythemod.Entity.EntityLoveHeart)p_76986_1_,p_76986_2_,p_76986_4_, p_76986_6_, p_76986_8_,p_76986_9_);
